...
const Form = ({type,post,setPost,submitting,handleSubmit}) => {
  return (
    <section className="w-full max-w-full flex-start flex-col font-montserrat">
      ...
      <form
        ...
        className="mt-10 w-full max-w-2xl flex flex-col gap-7 space-between glassmorphism"
      >
        <label>
        ...
        <label>
          <span className="font-semibold text-base text-gray-700">Tag {' '}<span className="font-normal">(#product, #webdevelopment, #idea)</span></span>
          <input 
            name="inputTag" 
            value={post.tag} 
